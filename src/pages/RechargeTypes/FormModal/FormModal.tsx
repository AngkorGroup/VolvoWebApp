...
interface FormModalProps {
	show: boolean;
	title: string;
	values?: RechargeTypeForm;
	onClose: () => void;
	onConfirm: (data: RechargeTypeForm) => void;
}

const initialValues: RechargeTypeForm = {
	id: '',
	name: '',
	tpCode: '',
};
...
const FormModal: React.FC<FormModalProps> = ({
	...
	const handleSubmit = (data: RechargeTypeForm) => {
		onConfirm(data);
		onClose();
	};
	return (
		<Dialog open={show} onClose={onClose} aria-labelledby='form-dialog-title'>
			...
			<Formik
				...
				validationSchema={RechargeTypeSchema}
			>
				{({ touched, errors }) => (
